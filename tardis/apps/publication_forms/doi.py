...
class DOI():
    ...
    def mint(self, experiment_id, uri, publisher="Monash University"):
        client = self._init_client(settings.MODC_DOI_MINT_DEFINITION, settings.MODC_DOI_ENDPOINT)
        ...
        response = client.service.MintDoi(self.api_id, resource, self.url_root+uri)
    ...
    def activate(self, doi=None):
        ...
        client = self._init_client(settings.MODC_DOI_ACTIVATE_DEFINITION, settings.MODC_DOI_ENDPOINT)
    ...
    def deactivate(self, doi=None):
        ...
        client = self._init_client(settings.MODC_DOI_DEACTIVATE_DEFINITION, settings.MODC_DOI_ENDPOINT)
