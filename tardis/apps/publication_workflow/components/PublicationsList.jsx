...
const PublicationsList = ({
  ...
  useEffect(() => {}, [releasedPubsList, retractedPubsList]);
  return (
    <Fragment>
      ...
      />
      <div className="row">
        {draftPubsList.length > 0 ? (
          draftPubsList.map(item => (
            <PublicationCard
              key={item.id}
        ...
        {scheduledPubsList.length > 0 ? (
          scheduledPubsList.map(item => (
            <PublicationCard
              key={item.id}
        ...
        {retractedPubsList.length > 0 ? (
          retractedPubsList.map(item => (
            <PublicationCard
              key={item.id}
        ...
        {releasedPubsList.length > 0 ? (
          releasedPubsList.map(item => (
            <PublicationCard
              key={item.id}
