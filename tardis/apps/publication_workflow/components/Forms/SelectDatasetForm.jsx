...
const SelectDatasetForm = ({ formik }) => {
    ...
    const handleExpChange = (event) => {
        ...
        fetchDatasetsForExperiment(event.target.value).then(result => setDatasetList(result)).catch(result => setDatasetList([]));
              ...
              && !formik.errors.selectedDatasets
                  ...
                  <Col className="col-md-6">
                      ...
                      <Table size="sm" responsive striped hover>
                          ...
                          <tbody>
                              {formik.values.selectedDatasets.map((item, index) => (
                                  <tr key={index}>
