...
urlpatterns = patterns(
    ...
    (r'^my_publications/$', 'tardis.apps.publication_workflow.views.my_publications'),
    (r'^draft_pubs_list/$', 'tardis.apps.publication_workflow.views.retrieve_draft_pubs_list'),
    # (r'^scheduled_pubs_list/$', 'retrieve_scheduled_pubs_list'),
    # (r'^released_pubs_list/$', 'retrieve_released_pubs_list'),
