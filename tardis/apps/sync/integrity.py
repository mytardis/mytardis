...
class IntegrityCheck(object):
    ...
    def get_datafiles_integrity(self):
        """Check whether all datafiles belonging to this experiment actually 
        exist on disk.
        ...
        output = {
            'files_ok': 0, 'files_missing': 0, 
            'files_incomplete': 0, 'datafiles': {} 
            }
    ...
    def all_files_complete(self):
        ...
        return results['files_missing'] == 0 and \
            results['files_incomplete'] == 0
