...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PublishAuthorisation'
        db.create_table('hpctardis_publishauthorisation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('auth_key', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.Experiment'])),
            ('authoriser', self.gf('django.db.models.fields.TextField')(default='')),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('party_record', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hpctardis.PartyRecord'], null=True, blank=True)),
            ('activity_record', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hpctardis.ActivityRecord'], null=True, blank=True)),
        ))
        db.send_create_signal('hpctardis', ['PublishAuthorisation'])

        # Adding model 'PublishAuthEvent'
        db.create_table('hpctardis_publishauthevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('publish_auth', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hpctardis.PublishAuthorisation'])),
            ('type', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=200)),
            ('date_authorised', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('hpctardis', ['PublishAuthEvent'])


    def backwards(self, orm):
        
        # Deleting model 'PublishAuthorisation'
        db.delete_table('hpctardis_publishauthorisation')

        # Deleting model 'PublishAuthEvent'
        db.delete_table('hpctardis_publishauthevent')
