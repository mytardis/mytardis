...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityRecord.subject'
        db.add_column('hpctardis_activityrecord', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityRecord.subject'
        db.delete_column('hpctardis_activityrecord', 'subject')
