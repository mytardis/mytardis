...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StorageBox.master_box'
        db.add_column(u'tardis_portal_storagebox', 'master_box',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_boxes', null=True, to=orm['tardis_portal.StorageBox']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StorageBox.master_box'
        db.delete_column(u'tardis_portal_storagebox', 'master_box_id')
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 5, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
