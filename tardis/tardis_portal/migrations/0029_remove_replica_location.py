...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'tardis_portal_providerparameter', ['location_id', 'name'])

        # Removing unique constraint on 'Replica', fields ['datafile', 'location']
        db.delete_unique(u'tardis_portal_replica', ['datafile_id', 'location_id'])

        # Deleting model 'Replica'
        db.delete_table(u'tardis_portal_replica')

        # Deleting model 'ProviderParameter'
        db.delete_table(u'tardis_portal_providerparameter')

        # Deleting model 'Location'
        db.delete_table(u'tardis_portal_location')


    def backwards(self, orm):
        # Adding model 'Replica'
        db.create_table(u'tardis_portal_replica', (
            ('datafile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.DataFile'])),
        ...
        db.create_unique(u'tardis_portal_replica', ['datafile_id', 'location_id'])

        # Adding model 'ProviderParameter'
        db.create_table(u'tardis_portal_providerparameter', (
        ...
        db.create_unique(u'tardis_portal_providerparameter', ['location_id', 'name'])

        # Adding model 'Location'
        db.create_table(u'tardis_portal_location', (
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
