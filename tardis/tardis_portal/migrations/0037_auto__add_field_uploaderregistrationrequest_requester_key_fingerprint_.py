...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploaderRegistrationRequest.requester_key_fingerprint'
        db.add_column(u'tardis_portal_uploaderregistrationrequest', 'requester_key_fingerprint',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Adding field 'UploaderRegistrationRequest.requester_key_type'
        db.add_column(u'tardis_portal_uploaderregistrationrequest', 'requester_key_type',
                      self.gf('django.db.models.fields.CharField')(default='RSA', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploaderRegistrationRequest.requester_key_fingerprint'
        db.delete_column(u'tardis_portal_uploaderregistrationrequest', 'requester_key_fingerprint')

        # Deleting field 'UploaderRegistrationRequest.requester_key_type'
        db.delete_column(u'tardis_portal_uploaderregistrationrequest', 'requester_key_type')
    ...
    models = {
        ...
        'tardis_portal.uploaderregistrationrequest': {
            ...
            'requester_key_type': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
