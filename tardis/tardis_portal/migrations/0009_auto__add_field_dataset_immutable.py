...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dataset.immutable'
        db.add_column('tardis_portal_dataset', 'immutable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dataset.immutable'
        db.delete_column('tardis_portal_dataset', 'immutable')
