    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "numerical_value",
                    models.FloatField(db_index=True, null=True, blank=True),
                ),
                (
                    "datetime_value",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datafile",
                    models.ForeignKey(
                        to="tardis_portal.DataFile", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dataset",
                    models.ForeignKey(
                        to="tardis_portal.Dataset", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "institution_name",
                    models.CharField(default=b"Monash University", max_length=400),
                ),
                ("description", models.TextField(blank=True)),
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1,
                        choices=[
                            (1, b"No public access (hidden)"),
                            (25, b"Ready to be released pending embargo expiry"),
                            (50, b"Public Metadata only (no data file access)"),
                            (100, b"Public"),
                        ],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "experiment",
                    models.ForeignKey(
                        to="tardis_portal.Experiment", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "manager_group",
                    models.ForeignKey(to="auth.Group", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "facility",
                    models.ForeignKey(
                        to="tardis_portal.Facility", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instrument",
                    models.ForeignKey(
                        to="tardis_portal.Instrument", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text=b"Does this license provide distribution rights?",
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True,
                        help_text=b"Can experiments continue to select this license?",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "aclOwnershipType",
                    models.IntegerField(
                        default=1, choices=[(1, b"Owner-owned"), (2, b"System-owned")]
                    ),
                ),
                (
                    "content_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        choices=[
                            ...
                            (3, b"Range"),
                            (4, b"Greater than"),
                            (5, b"Greater than or equal"),
                            (6, b"Less than"),
                            (7, b"Less than or equal"),
                        ],
                    ),
                ),
                ...
                (
                    "order",
                    models.PositiveIntegerField(default=9999, null=True, blank=True),
                ),
            ],
            options={
                "ordering": ("order", "name"),
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=1,
                        choices=[
                            (1, b"Experiment schema"),
                            (2, b"Dataset schema"),
                            (3, b"Datafile schema"),
                            (5, b"Instrument schema"),
                            (4, b"None"),
                        ],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        default=b"tardis.tardis_portal.storage.MyTardisLocalFileSystemStorage"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expiry_date",
                    models.DateField(
                        default=tardis.tardis_portal.models.token._token_expiry
                    ),
                ),
                (
                    "experiment",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="tardis_portal.UserProfile", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            ...
            name="schema",
            field=models.ForeignKey(
                to="tardis_portal.Schema", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="instrumentparametersets", to="tardis_portal.StorageBox"
            ),
        ),
        migrations.AddField(
            ...
            name="name",
            field=models.ForeignKey(
                to="tardis_portal.ParameterName", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="instrumentparameter",
            name="parameterset",
            field=models.ForeignKey(
                to="tardis_portal.InstrumentParameterSet", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="storage_box",
            field=models.ManyToManyField(
                related_name="experimentparametersets", to="tardis_portal.StorageBox"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="parameterset",
            field=models.ForeignKey(
                to="tardis_portal.ExperimentParameterSet", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="storage_box",
            field=models.ManyToManyField(
                related_name="datasetparametersets", to="tardis_portal.StorageBox"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="parameterset",
            field=models.ForeignKey(
                to="tardis_portal.DatasetParameterSet", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="dataset",
            name="experiments",
            field=models.ManyToManyField(
                related_name="datasets", to="tardis_portal.Experiment"
            ),
        ),
        migrations.AddField(
            model_name="dataset",
        ...
        migrations.AddField(
            ...
            name="storage_box",
            field=models.ManyToManyField(
                related_name="datafileparametersets", to="tardis_portal.StorageBox"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="parameterset",
            field=models.ForeignKey(
                to="tardis_portal.DatafileParameterSet", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
