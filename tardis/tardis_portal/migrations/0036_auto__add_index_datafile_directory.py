...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DataFile', fields ['directory']
        db.create_index(u'tardis_portal_datafile', ['directory'])


    def backwards(self, orm):
        # Removing index on 'DataFile', fields ['directory']
        db.delete_index(u'tardis_portal_datafile', ['directory'])
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
