...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tardis_portal_location', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))

        # Changing field 'ProviderParameter.value'
        db.alter_column('tardis_portal_providerparameter', 'value', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'ProviderParameter.name'
        db.alter_column('tardis_portal_providerparameter', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'Location.name'
        db.alter_column('tardis_portal_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))

        # Changing field 'ProviderParameter.value'
        db.alter_column('tardis_portal_providerparameter', 'value', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'ProviderParameter.name'
        db.alter_column('tardis_portal_providerparameter', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'tardis_portal.providerparameter': {
            ...
            'value': ('django.db.models.fields.CharField', [], {'max_length': '400', 'blank': 'True'})
        },
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
