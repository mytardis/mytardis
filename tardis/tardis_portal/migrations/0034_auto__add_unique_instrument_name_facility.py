...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Instrument', fields ['name', 'facility']
        db.create_unique(u'tardis_portal_instrument', ['name', 'facility_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Instrument', fields ['name', 'facility']
        db.delete_unique(u'tardis_portal_instrument', ['name', 'facility_id'])
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
