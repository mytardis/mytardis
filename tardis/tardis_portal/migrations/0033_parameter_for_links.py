...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatafileParameter.link_id'
        db.add_column(u'tardis_portal_datafileparameter', 'link_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatafileParameter.link_ct'
        db.add_column(u'tardis_portal_datafileparameter', 'link_ct',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatasetParameter.link_id'
        db.add_column(u'tardis_portal_datasetparameter', 'link_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DatasetParameter.link_ct'
        db.add_column(u'tardis_portal_datasetparameter', 'link_ct',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentParameter.link_id'
        db.add_column(u'tardis_portal_experimentparameter', 'link_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentParameter.link_ct'
        db.add_column(u'tardis_portal_experimentparameter', 'link_ct',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'InstrumentParameter.link_id'
        db.add_column(u'tardis_portal_instrumentparameter', 'link_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InstrumentParameter.link_ct'
        db.add_column(u'tardis_portal_instrumentparameter', 'link_ct',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatafileParameter.link_id'
        db.delete_column(u'tardis_portal_datafileparameter', 'link_id')

        # Deleting field 'DatafileParameter.link_ct'
        db.delete_column(u'tardis_portal_datafileparameter', 'link_ct_id')

        # Deleting field 'DatasetParameter.link_id'
        db.delete_column(u'tardis_portal_datasetparameter', 'link_id')

        # Deleting field 'DatasetParameter.link_ct'
        db.delete_column(u'tardis_portal_datasetparameter', 'link_ct_id')

        # Deleting field 'ExperimentParameter.link_id'
        db.delete_column(u'tardis_portal_experimentparameter', 'link_id')

        # Deleting field 'ExperimentParameter.link_ct'
        db.delete_column(u'tardis_portal_experimentparameter', 'link_ct_id')

        # Deleting field 'InstrumentParameter.link_id'
        db.delete_column(u'tardis_portal_instrumentparameter', 'link_id')

        # Deleting field 'InstrumentParameter.link_ct'
        db.delete_column(u'tardis_portal_instrumentparameter', 'link_ct_id')
