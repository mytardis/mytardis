...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParameterName.data_type'
        db.add_column('tardis_portal_parametername', 'data_type', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)

        # Adding field 'DatafileParameter.datetime_value'
        db.add_column('tardis_portal_datafileparameter', 'datetime_value', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExperimentParameter.datetime_value'
        db.add_column('tardis_portal_experimentparameter', 'datetime_value', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'DatasetParameter.datetime_value'
        db.add_column('tardis_portal_datasetparameter', 'datetime_value', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'ParameterName.data_type'
        db.delete_column('tardis_portal_parametername', 'data_type')

        # Deleting field 'DatafileParameter.datetime_value'
        db.delete_column('tardis_portal_datafileparameter', 'datetime_value')

        # Deleting field 'ExperimentParameter.datetime_value'
        db.delete_column('tardis_portal_experimentparameter', 'datetime_value')

        # Deleting field 'DatasetParameter.datetime_value'
        db.delete_column('tardis_portal_datasetparameter', 'datetime_value')
