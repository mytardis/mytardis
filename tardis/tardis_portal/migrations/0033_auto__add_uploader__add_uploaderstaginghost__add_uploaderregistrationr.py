...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tardis_portal_uploader', (
            ...
            ('user_agent_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('user_agent_version', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('user_agent_install_location', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('os_platform', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('os_system', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('os_release', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('os_version', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('os_username', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('machine', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('architecture', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('processor', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('memory', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('cpus', self.gf('django.db.models.fields.IntegerField')()),
            ('disk_usage', self.gf('django.db.models.fields.TextField')()),
            ('data_path', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('default_user', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('interface', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
            ('mac_address', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
            ('ipv4_address', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('ipv6_address', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('subnet_mask', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('hostname', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('wan_ip_address', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('created_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('tardis_portal', ['Uploader'])

        # Adding model 'UploaderStagingHost'
        db.create_table(u'tardis_portal_uploaderstaginghost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
            ('uses_hosts_allow', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('uses_iptables_firewall', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('uses_external_firewall', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('tardis_portal', ['UploaderStagingHost'])

        # Adding model 'UploaderRegistrationRequest'
        db.create_table(u'tardis_portal_uploaderregistrationrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uploader', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.Uploader'], unique=True)),
            ...
            ('approved_staging_host', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tardis_portal.UploaderStagingHost'], null=True, blank=True)),
            ('approved_username', self.gf('django.db.models.fields.CharField')(default=None, max_length=32, null=True, blank=True)),
        ...
        db.send_create_signal('tardis_portal', ['UploaderRegistrationRequest'])


    def backwards(self, orm):
        # Deleting model 'Uploader'
        db.delete_table(u'tardis_portal_uploader')

        # Deleting model 'UploaderStagingHost'
        db.delete_table(u'tardis_portal_uploaderstaginghost')

        # Deleting model 'UploaderRegistrationRequest'
        db.delete_table(u'tardis_portal_uploaderregistrationrequest')
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tardis_portal.uploaderregistrationrequest': {
            'Meta': {'object_name': 'UploaderRegistrationRequest'},
            ...
            'uploader': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Uploader']", 'unique': 'True'})
        },
