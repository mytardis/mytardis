...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FacilityManager'
        db.create_table(u'tardis_portal_facilitymanager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.Facility'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('tardis_portal', ['FacilityManager'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FacilityManager'
        db.delete_table(u'tardis_portal_facilitymanager')
    ...
    models = {
        ...
        'tardis_portal.facilitymanager': {
            'Meta': {'object_name': 'FacilityManager'},
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
