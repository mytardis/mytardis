...
class xmlData(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='xmlData', namespacedef_=''):
        ...
        if self.hasContent_():
            ...
            print "gago node:", self.node.tostring()
    ...
    def hasContent_(self):
        if (
            self.valueOf_ or self.node
            ):
            print "hascontent", self.node
            return True
        else:
            return False
        print "GG"
    ...
    def buildChildren(self, child_, node, nodeName_, from_subclass=False):
        ...
        #xmlData_ = self.gds_validate_string(child_, node, nodeName_)
        #self.xmlData = xmlData_
        
        print "hello", child_.text
