...
class ListEndpointsTest(MyTardisResourceTestCase):
    ...
    def test_list_endpoints(self):
        expected_output = {
            ...
            'experimentacl': {'list_endpoint': '/api/v1/experimentacl/', 'schema': '/api/v1/experimentacl/schema/'},
            'datasetacl': {'list_endpoint': '/api/v1/datasetacl/', 'schema': '/api/v1/datasetacl/schema/'},
            'datafileacl': {'list_endpoint': '/api/v1/datafileacl/', 'schema': '/api/v1/datafileacl/schema/'},
