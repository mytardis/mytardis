...
class DatasetResourceTest(MyTardisResourceTestCase):
    def setUp(self):
        ...
        self.dataset_with_tags = Dataset.objects.create(
    ...
    def test_get_tags(self):
        ...
        self.assertEqual(
            sorted(returned_data['tags']), ['keyword1', 'keyword2'])

    def test_update_tags(self):
        dataset_id = self.dataset_with_tags.id
        uri = '/api/v1/dataset/%d/' % dataset_id
        data = {
            'tags': ['keyword3', 'keyword4']
        }
        ...
        returned_data = json.loads(response.content)
        self.assertEqual(
            sorted(returned_data['tags']), ['keyword3', 'keyword4'])
