...
class MyTardisResourceTestCase(ResourceTestCaseMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.user.user_permissions.add(Permission.objects.get(codename="add_datafile"))
        self.user.user_permissions.add(
        ...
        self.testfacility = Facility(name="Test Facility", manager_group=self.testgroup)
        self.testfacility.save()
        self.testinstrument = Instrument(
            name="Test Instrument", facility=self.testfacility
        )
