...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExperimentAuthor.url'
        db.alter_column(u'tardis_portal_experimentauthor', 'url', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'ExperimentAuthor.url'
        db.alter_column(u'tardis_portal_experimentauthor', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=2000))
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 6, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
