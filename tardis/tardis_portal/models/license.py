...
class License(models.Model):
    ...
    allows_distribution = models.BooleanField(
        default=False, help_text="Does this license provide distribution rights?"
    )
    is_active = models.BooleanField(
        default=True, help_text="Can experiments continue to select this license?"
    )
    ...
    def get_suitable_licenses(cls, public_access_method=None):
        ...
        return with_none(cls.objects.filter(is_active=True, allows_distribution=False))
