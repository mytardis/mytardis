...
def send_account_approved_email(user):
    ...
    message = \
        ...
        " If you have an existing Monash account and would like to migrate your data and settings" \
        " to your new account, follow the instructions on Migrate your data.\n\n" \
        "Thanks,\n" \
        "MyTardis\n" \
        % user.username
    try:
