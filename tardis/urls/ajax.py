...
from tardis.tardis_portal.views import (
    ...
    retrieve_dataset_online_files_count,
...
json_urls = [
    ...
    url(r'^experiment/(?P<experiment_id>\d+)/get_experiment_permissions$',
        get_experiment_permissions,
...
ajax_urls = [
    ...
    url(r'^dataset_online_files_count/(?P<dataset_id>\d+)/$', retrieve_dataset_online_files_count,
        name='tardis.tardis_portal.views.retrieve_dataset_online_files_count'),
