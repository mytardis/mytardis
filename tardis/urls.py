...
core_urls = patterns(
    'tardis.tardis_portal.views',
    (r'^$', 'index'),
    url(r'^site-settings.xml/$',
        'machine.site_settings', name='tardis-site-settings'),
    ...
    url(r'^sftp_access/cyberduck/connection.png$',
        'images.cybderduck_connection_window', name='cyberduck_connection_window'),
    url(r'^sftp_access/$', 'pages.sftp_access', name='sftp_access'),
...
ajax_urls = patterns(
    ...
    url(r'^cache_dataset/(?P<dataset_id>\d+)/$',
        'ajax_actions.cache_dataset',
        name='cache_dataset'),
