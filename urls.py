...
urlpatterns = patterns('',
	...
	(r'^experiment/register/internal/$', 'tardis.tardis_portal.views.register_experiment_ws_xmldata_internal'),	
	...
	(r'^displayDatasetImage/(?P<dataset_id>\d+)/(?P<parameter_name>\w+)/$', 'tardis.tardis_portal.views.display_dataset_image'),
	(r'^displayDatafileImage/(?P<dataset_file_id>\d+)/(?P<parameter_name>\w+)/$', 'tardis.tardis_portal.views.display_datafile_image'),		
	(r'^experiment/view/(?P<experiment_id>\d+)/downloadExperiment/$', 'tardis.tardis_portal.views.downloadExperiment'),	
	...
	(r'^login/$', 'tardis.tardis_portal.views.monash_login'),
	(r'^accounts/login/$', 'tardis.tardis_portal.views.monash_login'),	
