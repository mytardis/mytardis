...
export var MyTardis = (function() {
    ...
    var DatasetFilter = Backbone.View.extend({
        ...
        _filterDescription: function(str) {
            ...
            return function(model) {
                var directory = model.get("directory");
                var searchString = model.get("description").toLowerCase();
                if (directory !== null) {
    ...
    module.DatasetTiles = Backbone.View.extend({
        ...
        _buildTile: function(tiles, model) {
            var view = new MyTardis.DatasetTile({ "model": model });
            view.render();
    ...
    module.DatasetTile = Backbone.View.extend({
        ...
        templateWrapper: {
            ...
            "dataset_size_badge": function() {
                ...
                return Mustache.to_html(
                    ...
                    {
                        "title": sprintf("Dataset size is ", this.size_human_readable),
        ...
        render: function() {
            ...
            var el = $(this.el);
            var data = _.defaults(_.clone(this.templateWrapper), this.model.attributes);
            // Render
