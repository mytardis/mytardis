...
const SelectDatasetForm = ({ formik }) => {
  ...
  const handleDatasetDelete = (e, item) => {
    ...
    const newSelectedDatasetList = selectedDatasetList.filter(
      it => it !== item,
    );
  ...
  return (
    <>
      <p>
        ...
        Below is all the data you&apos;ve
        generated. Select the datasets you want to include in this publication.
      </p>
      <Card>
        <Card.Body>
          ...
          <Form.Group className="mb-3" controlId="formGroupDescription">
            ...
            <Form.Control
              ...
              isValid={
                formik.touched.publicationDescription
          ...
          <Row>
            ...
            <Form.Control
              ...
              onChange={formik.handleChange}
              isValid={
                formik.touched.selectedDatasets
                    ...
                    <tr key={item.dataset.id}>
                      ...
                      <td>
                        ...
                        <span
                          ...
                          onClick={e => handleDatasetDelete(e, item)}
                          role="button"
                          tabIndex={0}
                        >
