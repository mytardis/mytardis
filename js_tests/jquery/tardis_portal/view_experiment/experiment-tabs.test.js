...
QUnit.test("Load experiment tabs", function(assert) {
 ...
 "    </div>\n" +
    ...
    $.getScript("../tardis/tardis_portal/static/js/jquery/tardis_portal/view_experiment/experiment-tabs.js")
        .done(function( data, textStatus, jqxhr ) {
            assert.equal(jqxhr.status, 200);
            console.log("Loaded view_experiment/experiment-tabs.js");
        })
        .fail(function( jqxhr, settings, exception ) {
            console.log("Failed to load view_experiment/experiment-tabs.js");
            throw exception;
        });
